    ...
    if query.query == "ORU_POTTAN_PM_VANNU_🐓_ANANNE_THONUNNU":
        answers.append(
            InlineQueryResultArticle(
                title="Deploy",
                input_message_content=InputTextMessageContent(f"{REPLY_MESSAGE}\n\n<b>You can't use this bot in your group, for that you have to make your own bot from the [SOURCE CODE](https://github.com/QueenArzoo/VCPvtBot) below.</b>", disable_web_page_preview=True),
