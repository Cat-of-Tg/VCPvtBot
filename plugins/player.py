...
async def not_chat(_, m: Message):
    buttons = [
        ...
        [
            InlineKeyboardButton('How to Make', url='https://youtu.be/FOJT8T1SCY0'),
            InlineKeyboardButton('👨🏼‍🦯 Help', callback_data='help')       
        ]
        ]
    k=await m.reply("<b>You can't use this bot in this group, for that you have to make your own bot from the [SOURCE CODE](https://github.com/QueenArzoo/VCPvtBot) below.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
